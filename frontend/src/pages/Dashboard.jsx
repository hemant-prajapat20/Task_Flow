            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div>
                <div className="flex items-center justify-center gap-1.5 text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">
                  <div className="w-2.5 h-2.5 rounded-full bg-slate-400 dark:bg-slate-500 shrink-0"></div> <span className="truncate">To Do</span>
                </div>
              ...
              <div>
                <div className="flex items-center justify-center gap-1.5 text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">
                  <div className="w-2.5 h-2.5 rounded-full bg-amber-400 dark:bg-amber-500 shrink-0"></div> <span className="truncate">In Progress</span>
                </div>
              ...
              <div>
                <div className="flex items-center justify-center gap-1.5 text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">
                  <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 shrink-0"></div> <span className="truncate">Done</span>
                </div>
